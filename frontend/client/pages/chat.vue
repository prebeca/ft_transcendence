      ...
      <v-row align="start" justify="center">
              ...
              <v-dialog v-model="channelDialog" persistent max-width="600px">
                <template v-slot:activator>
                  <v-btn
                    class="mt-5 mx-8"
                    color="primary"
                    @click="channelDialog = !channelDialog"
                  >
        ...
        >
          ...
          <v-list id="Chat" height="577px" class="mt-3 d-flex flex-column">
            <v-list-item-group>
              <div v-for="(msg, index) in currentChanel.messages" :key="index">
                ...
                <v-divider
                  v-if="index < currentChanel.messages.length - 1"
                  :key="index"
                ></v-divider>
              </div>
            </v-list-item-group>
